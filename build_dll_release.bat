...
"C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe" project\safe99_renderer\safe99_renderer\safe99_renderer.vcxproj /t:rebuild /p:configuration=release /p:platform=x64
"C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe" project\safe99_renderer\safe99_renderer\safe99_renderer.vcxproj /t:rebuild /p:configuration=release /p:platform=Win32