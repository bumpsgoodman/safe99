...
bool __stdcall chunked_memory_pool_initialize(chunked_memory_pool_t* p_pool, const size_t element_size, const size_t num_elements_per_chunk)
{
    ...
    {
        ASSERT(false, "Failed to create new chunk");
...
void __stdcall chunked_memory_pool_release(chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
...
void __stdcall chunked_memory_pool_reset(chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
...
void* __stdcall chunked_memory_pool_alloc_or_null(chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
...
void __stdcall chunked_memory_pool_dealloc(chunked_memory_pool_t* p_pool, void* p_element_or_null)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
...
size_t __stdcall chunked_memory_pool_get_element_size(const chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
    return p_pool->element_size;
}

size_t __stdcall chunked_memory_pool_get_num_elements_per_chunk(const chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
    return p_pool->num_elements_per_chunk;
}

size_t __stdcall chunked_memory_pool_get_num_alloc_elements(const chunked_memory_pool_t* p_pool)
{
    ASSERT(p_pool != NULL, "p_pool == NULL");
...
static bool create_new_chunk(chunked_memory_pool_t* p_pool)
{
    ...
    if (pa_new_node == NULL)
    {
        ASSERT(false, "Failed to malloc new node");
    ...
    {
        ASSERT(false, "Failed to malloc new chunk");
    ...
    {
        ASSERT(false, "Failed to malloc index table");
