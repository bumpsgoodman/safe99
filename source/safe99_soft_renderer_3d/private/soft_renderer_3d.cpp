...
static void __stdcall draw_mesh(i_soft_renderer_3d_t* p_this, const i_mesh3_t* p_mesh, const matrix_t* p_transform_mat, const bool b_wireframe)
{
    ...
    i_vertex_buffer3_t* p_vertex_buffer = (i_vertex_buffer3_t*)p_mesh->vtbl->get_vertex_buffer(p_mesh);
    ...
    const vector3_t* p_texcoords = p_vertex_buffer->vtbl->get_tex_coord_or_null(p_vertex_buffer);
